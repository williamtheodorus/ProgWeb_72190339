...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="jumbotron"><br>
            ...
            <hr class="my-4">
            <form method="post" action="/about/update/{{ $desc->id }}">
            @csrf <!-- {{ csrf_field() }} -->
            @method('PUT') <!-- {{ method_field('PUT') }} -->
                <input type="hidden" name="id" id="id" value="@php echo $desc->id @endphp">
                <input type="text-area" class="form-control" name="desc" id="desc" value="@php echo $desc->desc @endphp">
                <br>
